...
from flask import Flask, jsonify, render_template #jsonify is a lib from flask thay turns strutures into json
...
# Writing the data to a Mongo db file
...
def get_hello(name="guest"):
    return render_template("hello.html", names=[name, "A", "B", "C"])
